...
<div class="form-data">
    ...
    <div class="body">
        <form name="form-add-school-periods" action="insert.php" method="POST" autocomplete="off" autocapitalize="on">
            <div class="wrap">
                <div class="first">
                    <label for="txtspid" class="label">Ciclo escolar</label>
                    <input id="txtspid" class="text" type="text" name="txtspid" value="" placeholder="ID Ciclo Escolar" maxlength="20" onkeyup="this.value = this.value.toUpperCase()" required autofocus />
