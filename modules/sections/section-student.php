...
<div class="nav-home">
    ...
    <ul>
        ...
        <li><a class="<?php if ($output[1] == 'calification') {
                echo 'active';
            } ?>" href="/modules/calification"><span class="icon">bookmark_added</span>Calificaciones</a></li>
    </ul>
</div>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a class="<?php if ($output[1] == 'calification') {
                        echo 'active-menu';
                    } ?>" href="/modules/calification"><span class="icon">bookmark_added</span><span class="text">Calificaciones</span></a>
                </li>
            </ul>
        </nav>
    </header>
