...
require_once($_SESSION['raiz'] . '/modules/sections/role-access-editor.php');
...
<div class="nav-home">
    ...
    <ul>
        ...
        <li><a class="<?php if ($output[1] == 'subjects') {
                            echo 'active';
                        } ?>" href="/modules/subjects"><span class="icon">library_books</span>Materias</a></li>
            ...
            <ul>
                ...
                <li>
                    <a class="<?php if ($output[1] == 'subjects') {
                        echo 'active-menu';
                    } ?>" href="/modules/subjects"><span class="icon">library_books</span><span class="text">Materias</span></a>
                </li>
                <li>
