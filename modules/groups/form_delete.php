...
<div class="form-data">
    ...
    <div class="delete">
        ...
        <form name="form-delete-administratives" action="delete.php" method="POST">
            <input style="display: none;" type="text" name="txtgroupid" value="<?php echo $_POST['txtgroup']; ?>" />
            <input style="display: none;" type="text" name="txtgroupschoolperiod" value="<?php echo $_POST['txtgroupschoolperiod']; ?>" />
