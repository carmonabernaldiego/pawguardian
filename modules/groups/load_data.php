...
$sql = "SELECT COUNT(id_group) AS total FROM groupschool WHERE school_period = '" . $_SESSION['school_period'] . "'";
...
if (!empty($_POST['search'])) {
	...
	$sql = "SELECT * FROM groupschool WHERE id_group LIKE '%" . $_POST['search'] . "%' AND school_period = '" . $_SESSION['school_period'] . "' OR name LIKE '%" . $_POST['search'] . "%' AND school_period = '" . $_SESSION['school_period'] . "' ORDER BY name";
	...
	$sql = "SELECT * FROM groupschool WHERE school_period = '" . $_SESSION['school_period'] . "' ORDER BY name LIMIT $inicio, $max";
