        ...
        <form name="form-update-students" action="update.php" method="POST" autocomplete="off" autocapitalize="on">
            <div class="wrap">
                ...
                <div class="last">
                    ...
                    <input id="txtusercurp" class="text" type="text" name="txtcurp"
                           value="<?php echo $_SESSION['student_curp']; ?>"
                    ...
                    <input id="txtuserrfc" class="text" type="text" name="txtrfc"
                           value="<?php echo $_SESSION['student_rfc']; ?>" placeholder="XAXX010101000"
                    ...
                    <input id="txtuserphone" class="text" type="text" name="txtphone"
                           ...
                           title="Ingresa un número de teléfono válido." placeholder="9998887766" maxlength="10"
                           required/>
